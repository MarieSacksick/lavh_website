import { ActorProfileProps } from '../components/ActorProfile/ActorProfile';

export const actors: ActorProfileProps[] = [
  {
    id: 'louis-albertosi',
    prenom: 'Louis',
    nom: 'Albertosi',
    imageSrc: '/actors/Albertosi_Louis.jpg',
...
En 2024-2025, il jouera dans 4,7% de liberté de Samuel Hercule et Métilde Weyergans.`,
  ...
  },
  {
    ...
    prenom: 'Évelyne',
    nom: 'Istria',
    imageSrc: '/actors/Istria_Evelyne_24.jpg',
...
Les spectateurs des deux dernières années se rappellent les très poignantes lectures qu'elle fit de La Place du diamant et de La Guerre n'a pas un visage de femme.`,
  },
  {
    ...
    prenom: 'Guillaume',
    nom: 'Lévêque',
    imageSrc: '/actors/guillaume_leveque.jpg',
...
Depuis cette date, chaque été, il s'emploie à proposer un programme de beaux textes lus ou dits par des comédiens de talent qu'il choisit et dont il aime s'entourer. Il développe également ces lectures en dehors de la saison estivale ainsi qu'en direction des scolaires -qui semblent s'en être bien trouvés...`,
  },
  {
    ...
    prenom: 'Mélodie',
    nom: 'Richard',
    imageSrc: '/actors/Richard_melodie_24.jpg',
    description: `À sa sortie du Conservatoire, Mélodie Richard fait la rencontre décisive de Krystian Lupa, avec qui elle joue dans ses trois créations francophones -dont récemment Les Émigrants. Elle fait rapidement d'autres rencontres essentielles, comme Christophe Honoré, Thomas Ostermeier, Georges Lavaudant et Célie Pauthe, qui la dirigent dans les plus grands rôles du répertoire (La Mouette, Bérénice, Cléopâtre, Électre).

Dans le monde gris de l'Orage d'Ostrovski (mis en scène aux Bouffes du Nord par Denis Podalydès), elle révèle toute la poésie et l'indépendance de son personnage Katherina. Deux qualités que les spectateurs ont retrouvées l'an passé lors de sa lecture de Jane Eyre dans ce même château de Tracy où elle revient.
